 ...
 * - CORS ouvert au frontend Next.js (voir origines autorisées ci-dessous).
 */
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        // Spring Security récent : le UserDetailsService se passe directement
        // au constructeur (l'ancien constructeur vide + setUserDetailsService()
        // a été retiré de l'API).
